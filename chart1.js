...
// Sort data in descending order based on 'Gross tertiary education enrollment (%)'
...
const yScale = d3.scaleLinear()
  .domain([0, d3.max(top10, d => d['Gross tertiary education enrollment (%)'])])
  .nice()
  .range([chartHeight, 0]);
...
chartGroup.selectAll(".bar-primary")
  ...
  .attr("y", d => yScale(d['Gross tertiary education enrollment (%)']))
  .attr("width", xScale.bandwidth())
  .attr("height", d => chartHeight - yScale(d['Gross tertiary education enrollment (%)']))
...
svg.append("text")
    ...
    .text("Top 10 Countries with highest Gross Tertiary Enrollment Ratio");
