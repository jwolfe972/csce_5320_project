...
data.forEach(function(d) {
    ...
    d['GDP'] = d['GDP'].split(",").join("");
    if(d['GDP']==''){
      d['GDP'] = '0$'
    }
    d['GDP'] = parseFloat(d['GDP'].replace("$", ""));
...
// Sort data in descending order based on 'Minimum wage'
...
svg.append("text")
    ...
    .text("Top 10 Countries with best tertiary education enrollment and GDP ($) ");
